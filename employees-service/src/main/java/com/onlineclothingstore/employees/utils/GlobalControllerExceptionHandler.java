package com.onlineclothingstore.employees.utils;


import com.onlineclothingstore.employees.utils.exceptions.InUseException;
import com.onlineclothingstore.employees.utils.exceptions.InvalidInputException;
...
public class GlobalControllerExceptionHandler {
    ...
    public HttpErrorInfo handleIsEmptyException(WebRequest request, Exception ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }
