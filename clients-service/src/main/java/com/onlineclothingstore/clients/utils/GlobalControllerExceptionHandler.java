package com.onlineclothingstore.clients.utils;


import com.onlineclothingstore.clients.utils.exceptions.BadPostalCodeException;
import com.onlineclothingstore.clients.utils.exceptions.InUseException;
import com.onlineclothingstore.clients.utils.exceptions.InvalidInputException;
...
public class GlobalControllerExceptionHandler {
  ...
  /*  @ResponseStatus(UNPROCESSABLE_ENTITY)
    ...
    @ResponseStatus(UNPROCESSABLE_ENTITY)
    @ExceptionHandler(BadPostalCodeException.class)
    public HttpErrorInfo handleBadPostalCodeException(WebRequest request, Exception ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }
